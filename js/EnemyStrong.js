enemyStrong = function (index, game, player, fireballs,x,y) {
...
enemyStrong.prototype.damage = function(damage) {
...
enemyStrong.prototype.update = function(pathCounter) {
    if (pathCounter < 50)  {
    ...
    //this.enemy.enemyText = this.game.add.text(this.enemy.body.x - 5, this.enemy.body.y - 30, this.enemyHp);
        ...
        if (this.facingEnemy == 'right') {
            fireball = this.fireballs.create(this.enemy.body.x + this.enemy.body.width / 2 + 45, this.enemy.body.y + this.enemy.body.height / 2 + 5, 'arrow-down');
        } else {
            fireball = this.fireballs.create(this.enemy.body.x + this.enemy.body.width / 2 - 40, this.enemy.body.y + this.enemy.body.height / 2 + 5, 'arrow-up');
        }
